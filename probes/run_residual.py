"""Project out what ordinary fine-tuning does, then measure what is left.
...
def main(argv=None) -> int:
    ...
    res = {"prereg": "probes/RESIDUAL_PREREGISTRATION.md", "k": args.k,
    ...
    print(f"[res] KILL 2 random frame resid_frac = {rf_rand:.4f} (must be near 1)", flush=True)
    if rf_rand is None or rf_rand < 0.80:
